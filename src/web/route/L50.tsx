...
export interface L50Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const L50: React.FC<L50Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
...
<clipPath
  ...
  <g
     id="layer1"
     transform="translate(-715.6705,-293.32262)"><g
...
<g
   transform="matrix(1.9120607,0,0,-1.9120607,-77.981939,1405.6838)"
   id="g18942">
  <g
     id="g18944"
    ...
    <g
       id="g18950"
       transform="translate(454.7281,540.2463)">
      <path
    ...
    <g
       id="g18954"
       transform="translate(417.3718,541.6171)">
      <path
    ...
    <g
       id="g18958"
       transform="translate(438.422,565.9705)">
      <path
    ...
    <g
       id="g18962"
       transform="translate(435.8568,566.6735)">
      <path
