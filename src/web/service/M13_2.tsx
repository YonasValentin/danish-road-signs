...
export interface M13_2Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const M13_2: React.FC<M13_2Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
 ...
 <path d="m352.77 308.13-26.247 311.66h-139.79v164.44h624.72v-164.44h-145.98l-25.11-311.66h-92.418l-43.5 177.31-41.06-177.31z"/>
 <path d="m583.61 411.66 24.843 208.15h-79.544z" fill="#fff"/>
 <path d="m415.82 411.45 54.701 208.34h-72.456z" fill="#fff"/>
  </svg>
);

M13_2.displayName = 'M13_2';
