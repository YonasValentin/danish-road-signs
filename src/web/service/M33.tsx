...
export interface M33Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const M33: React.FC<M33Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
 ...
 <path d="m497.99 207.63-311.53 311.53h73.303v293.21h476.47v-293.21h73.303l-73.303-73.303v-164.94h-73.303v91.629z" fillOpacity=".99029"/>
 <path d="m427.22 538.49h144.62v144.62h-144.62z" fill="#fff"/>
  </svg>
);
