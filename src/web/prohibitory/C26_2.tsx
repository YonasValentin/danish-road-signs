...
export interface C26_2Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const C26_2: React.FC<C26_2Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
  ...
  <g
    ...
    <g
       id="g3942"
       transform="matrix(9.5367475,0,0,-9.5367475,819.01037,653.25378)">
      <path
         d="m 0,0 0,3.201 -3.379,-9.39 c -0.142,-0.391 -0.925,-1.102 -1.85,-0.675 -0.604,0.284 -1.031,0.924 -0.675,1.849 l 3.806,10.457 0,4.055 -1.921,-5.229 C -4.197,3.77 -4.731,3.522 -5.229,3.699 -5.691,3.877 -5.94,4.411 -5.762,4.873 l 3.059,8.358 c 0.391,1.104 1.352,1.85 2.561,1.85 0.925,0 1.778,-0.498 2.276,-1.209 L 5.3,8.964 C 5.549,8.608 5.584,8.43 5.584,8.039 l 0,-3.273 c 0,-0.498 -0.391,-0.853 -0.853,-0.853 -0.463,0 -0.854,0.355 -0.854,0.853 l 0,3.024 -1.103,1.707 0,-9.853 2.241,-4.766 c 0.32,-0.675 0.036,-1.423 -0.604,-1.742 -0.641,-0.285 -1.423,0 -1.743,0.64 l -2.49,5.335 C 0.035,-0.569 0,-0.356 0,0"
         id="path3944" />
    </g>
    <g
       id="g3946"
       transform="matrix(9.5367475,0,0,-9.5367475,813.58587,455.83166)">
      <path
         d="m 0,0 c -1.387,0 -2.525,-1.138 -2.525,-2.525 0,-1.388 1.138,-2.526 2.525,-2.526 1.351,0 2.49,1.138 2.49,2.526 C 2.49,-1.138 1.351,0 0,0"
         id="path3948" />
    </g>
  </g>
  </svg>
