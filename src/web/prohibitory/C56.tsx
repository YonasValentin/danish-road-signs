...
export interface C56Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const C56: React.FC<C56Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
  ...
  <g
    ...
    <g
       id="g3512"
       transform="matrix(9.5986193,0,0,-9.5986193,402.53458,596.3768)">
      <path
