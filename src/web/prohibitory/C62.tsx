...
export interface C62Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const C62: React.FC<C62Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
  ...
  <g
     id="layer1"
     transform="translate(-135.54433,-361.99688)">
    <g
       transform="translate(-501.54702,586.32528)"
       id="layer1-0" />
    <g
       id="g3958"
       transform="matrix(9.5334226,0,0,-9.5334226,135.54433,562.74216)">
      <path
    ...
    <g
       id="g3962"
       transform="matrix(9.5334226,0,0,-9.5334226,485.14542,562.74216)">
      <path
         d="M 0,0 C 0,-3.486 -1.138,-6.723 -3.058,-9.355 L -24.934,12.52 c 2.597,1.921 5.834,3.094 9.32,3.094 C -7.007,15.614 0,8.607 0,0 M -28.134,9.319 C -30.091,6.722 -31.265,3.45 -31.265,0 c 0,-8.607 7.007,-15.65 15.651,-15.65 3.485,0 6.722,1.138 9.319,3.094 L -28.134,9.319 z"
         id="path3964" />
    </g>
  </g>
  </svg>
