...
export interface C23_3Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const C23_3: React.FC<C23_3Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
  ...
  <g
    ...
    <g
       id="g3764"
       transform="matrix(9.5032379,0,0,-9.5032379,887.60365,651.3009)">
      <path
    ...
    <g
       id="g3768"
       transform="matrix(9.5032379,0,0,-9.5032379,754.42338,639.46842)">
      <path
    ...
    <path
       d="m 755.78329,489.05212 122.36369,0 0,146.35937 -122.36369,0 0,-146.35937 z m -1.35896,154.47514 125.40472,0 c 1.69158,0 3.37365,-0.67473 4.73262,-2.0337 1.34946,-1.34946 2.03369,-3.04103 2.03369,-5.40734 l 0,-148.05094 c 0,-2.02419 -0.68423,-4.05788 -2.03369,-5.40734 -1.35897,-1.34946 -3.04104,-2.0337 -4.73262,-2.0337 l -125.40472,0 c -4.05789,0 -6.76631,3.05054 -6.76631,7.44104 l 0,148.05094 c 0,2.36631 0.68423,4.05788 2.03369,5.40734 1.01685,1.35897 2.69892,2.0337 4.73262,2.0337"
       id="path3772" />
  </g>
  </svg>
);

C23_3.displayName = 'C23_3';
