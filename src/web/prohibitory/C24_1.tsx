...
export interface C24_1Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const C24_1: React.FC<C24_1Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
  ...
  <g
    ...
    <g
       id="g3652"
       transform="matrix(9.5030983,0,0,-9.5030983,726.02709,663.8093)">
      <path
         d="m 0,0 c -0.996,0 -1.814,0.783 -1.814,1.778 0,0.996 0.818,1.814 1.814,1.814 0.996,0 1.778,-0.818 1.778,-1.814 C 1.815,0.817 0.996,0 0,0 m 0,5.371 c -1.992,0 -3.592,-1.601 -3.592,-3.593 0,-1.956 1.6,-3.557 3.592,-3.557 1.957,0 3.557,1.601 3.557,3.557 0,1.992 -1.6,3.593 -3.557,3.593"
         id="path3654" />
    </g>
    <g
       id="g3656"
       transform="matrix(9.5030983,0,0,-9.5030983,884.21567,652.99382)">
      <path
         d="m 0,0 c -1.672,0 -2.988,1.316 -2.988,2.988 0,1.671 1.316,3.023 2.988,3.023 1.672,0 3.024,-1.352 3.024,-3.023 C 3.024,1.316 1.672,0 0,0 m 0,8.856 c -3.273,0 -5.904,-2.596 -5.904,-5.868 0,-3.272 2.631,-5.905 5.904,-5.905 3.273,0 5.905,2.633 5.905,5.905 C 5.905,6.26 3.273,8.856 0,8.856"
         id="path3658" />
    </g>
    <g
       id="g3660"
       transform="matrix(9.5030983,0,0,-9.5030983,807.15124,587.75695)">
      <path
         d="M 0,0 C -0.214,0 -0.249,0.142 -0.214,0.284 L 1.921,8.999 C 1.956,9.07 2.027,9.213 2.134,9.213 l 2.419,0 c 0.106,0 0.213,-0.108 0.213,-0.249 l 0,-5.55 C 4.766,3.201 4.695,3.023 4.517,2.952 3.308,2.348 2.134,1.209 1.423,0 L 0,0 z m 5.975,8.964 c 0,0.106 0.072,0.249 0.214,0.249 l 2.205,0 c 0.143,0 0.178,-0.143 0.214,-0.214 L 9.888,3.948 C 9.924,3.735 9.746,3.664 9.604,3.664 9.141,3.77 8.643,3.841 8.145,3.841 7.505,3.841 6.865,3.77 6.26,3.592 6.082,3.557 5.975,3.699 5.975,3.806 l 0,5.158 z m 2.17,-6.367 c 1.601,0 3.13,-0.605 4.268,-1.637 0.25,-0.213 0.641,-0.177 0.89,0.072 0.213,0.249 0.177,0.64 -0.072,0.853 -0.568,0.533 -1.351,0.961 -1.671,1.138 -0.071,0.036 -0.142,0.142 -0.178,0.285 l -1.494,5.905 0.569,0 c 0.321,0 0.569,0.249 0.569,0.568 0,0.356 -0.213,0.605 -0.569,0.605 l -8.892,0 c -0.249,0 -0.498,-0.142 -0.569,-0.391 l -1.85,-7.541 -8.501,0 c -0.782,0 -1.28,-0.605 -1.102,-1.316 l 0.818,-3.344 c 0.284,0.107 0.711,0.179 1.102,0.179 1.743,0 3.344,-1.104 3.913,-2.775 l 6.296,0 C 1.6,-4.41 1.6,-4.055 1.6,-3.806 c 0,3.308 2.739,6.403 6.545,6.403"
         id="path3662" />
    </g>
  </g>
  </svg>
