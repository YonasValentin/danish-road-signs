...
export interface C31Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const C31: React.FC<C31Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
  ...
  <g
    ...
    <g
       id="g4130"
       transform="matrix(9.4695486,0,0,-9.4695486,1295.429,530.8575)">
      <path
         d="m 0,0 1.281,0 0,2.169 1.743,0.605 0,-2.774 1.777,0 0,-1.494 -1.777,0 0,-3.663 c 0,-0.463 0.249,-0.605 0.604,-0.605 0.356,0 0.747,0.107 1.067,0.178 L 4.909,-7.078 C 4.019,-7.363 2.917,-7.434 2.348,-7.221 1.601,-6.9 1.281,-6.438 1.281,-5.478 l 0,3.984 L 0,-1.494 0,0 z m -11.346,-2.81 0.355,5.656 5.727,0 0,-1.886 -4.019,0 -0.107,-1.743 c 0.569,0.178 1.529,0.285 2.241,0.107 1.671,-0.462 2.596,-1.814 2.525,-3.13 0,-0.569 0,-0.889 -0.284,-1.458 -0.712,-1.53 -2.099,-2.134 -3.735,-2.099 -1.352,0 -2.063,0.427 -3.237,1.103 l 0.925,1.565 c 0.783,-0.534 1.636,-0.96 2.454,-0.925 0.818,0.036 2.063,0.427 1.956,1.849 -0.035,0.606 -0.497,1.423 -1.85,1.423 -0.569,0 -0.888,-0.177 -1.316,-0.604 l -1.635,0.142 z"
         id="path4132" />
    </g>
  </g>
  </svg>
