...
export interface A43_3Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const A43_3: React.FC<A43_3Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
...
<g
   id="g4744"
   transform="matrix(-9.5220027,0,0,-9.5220027,42.761331,453.13109)">
  <path
