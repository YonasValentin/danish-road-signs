...
export interface D15_3Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const D15_3: React.FC<D15_3Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
  ...
  <g
    ...
    <g
       id="g3292"
       transform="matrix(-6.4522268,6.9785162,6.9785162,6.4522268,1112.3757,681.42846)">
      <path
         d="m 0,0 c 0,-11.58 -9.442,-21.021 -21.021,-21.021 -11.579,0 -21.021,9.441 -21.021,21.021 0,11.579 9.442,21.021 21.021,21.021 C -9.442,21.021 0,11.579 0,0"
         id="path3294" />
    </g>
    <path
       id="path3298"
    ...
    <g
      ...
      <path
         d="m 0,0 0,-24.014 4.312,0 0,24.014 5.985,-1.176 0.142,0 c 0.321,0 0.606,0.286 0.606,0.606 0,0.107 -0.071,0.249 -0.142,0.356 L 2.636,11.152 C 2.529,11.33 2.351,11.401 2.173,11.401 1.995,11.401 1.817,11.33 1.71,11.152 L -6.556,-0.214 c -0.071,-0.107 -0.142,-0.249 -0.142,-0.356 0,-0.32 0.285,-0.606 0.606,-0.606 l 0.142,0 L 0,0 z m 22.019,-6.912 c 0,-10.903 -8.943,-19.845 -19.846,-19.845 -10.903,0 -19.845,8.942 -19.845,19.845 0,10.903 8.942,19.845 19.845,19.845 10.903,0 19.846,-8.942 19.846,-19.845"
         id="path3302" />
    </g>
  </g>
  </svg>
