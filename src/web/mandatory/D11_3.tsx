...
export interface D11_3Props extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
}

export const D11_3: React.FC<D11_3Props> = ({
  width = 100,
  height = 100,
  ...props
}) => (
  ...
  <g
    ...
    <g
       id="g3300"
       transform="matrix(0,9.5042579,9.5042579,0,1313.7024,514.07737)">
      <path
